...
🚀 Built with Next.js, powered by MongoDB, styled with TailwindCSS, and secured with NextAuth. Uses Gemini AI for AI-powered features, with a beautiful UI powered by ShadCN UI and React Hook Form + Zod for robust form validation.
